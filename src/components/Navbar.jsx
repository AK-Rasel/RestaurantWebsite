        ...
        <div className="navbar-end">
          <div className="hidden lg:flex">
            ...
            <div className="dropdown dropdown-end mr-3">
              ...
              <div
                tabIndex={0}
                className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow border-orange"
              >
                <div className="card-body">
                  <span className="font-bold text-lg">8 Items</span>
                  <span className="text-red font-semibold">Subtotal: $999</span>
                  <div className="card-actions">
                    <button className="btn rounded-full px-4 hover:bg-transparent hover:border-orange  bg-orange btn-block">
                      View cart
                    </button>
                  </div>
                </div>
